...
class Settings(BaseSettings):
    ...
    # Telemetry configuration - DISABLED by default for simplified deployment
...
def get_settings() -> Settings:
    ...
    # Read telemetry config - DISABLED by default
    settings_dict["TELEMETRY_ENABLED"] = os.getenv("TELEMETRY", "false").strip().lower() == "true"
