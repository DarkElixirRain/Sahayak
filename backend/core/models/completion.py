...
class CompletionResponse(BaseModel):
    ...
    # Optional URL of an audio rendition of the response. For the MVP voice
    # flow this points to a single pre-recorded dummy response audio file.
    # Real dynamic TTS will replace it later. Clients must keep working when
    # this is absent/null.
